...
new = (
    ' "\\n\\nTienes 8 herramientas. REGLAS OBLIGATORIAS:"\n'
    ...
    '    "\\n- NUNCA digas que no puedes validar o asignar tags. Siempre tienes esas herramientas."\n'
...
if old in content:
    ...
    print('FAIL: texto no encontrado')
